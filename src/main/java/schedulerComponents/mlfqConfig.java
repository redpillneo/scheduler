...
public class mlfqConfig extends javax.swing.JPanel {
        ...
        private void initComponents() {
                ...
                priorityPolicy.setModel(new javax.swing.DefaultComboBoxModel<>(
                                new String[] { "Higher Before Lower", "Fixed Time Slots" }));
        ...
        private void generateQueuesActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_generateQueuesActionPerformed
                ...
                try {
                        ...
                        JOptionPane.showMessageDialog(this, "Invalid number of queues. Please inoput an integer.",
                ...
                for (Queue queue : queues) {
                        ...
                        newQueue.schedAlgoOption.addActionListener(new ActionListener() {// add actionlistner to listen
                                @Override
                                public void actionPerformed(ActionEvent e) {
                                        String s = (String) newQueue.schedAlgoOption.getSelectedItem();// get the
                                        newQueue.quantumInput.setEnabled(s == "Round Robin");
                                        switch (s) {// check for a match
                                                case "Shortest Remaining Time First":
                                                        queue.schedAlgo = "SRTF";
                                                        break;
                                                case "First Come First Serve":
                                                        queue.schedAlgo = "FCFS";
                                                        break;
                                                case "Shortest Job First":
                                                        queue.schedAlgo = "SJF";
                                                        break;
                                                case "Non-preemptive CPU":
                                                        queue.schedAlgo = "NPC";
                                                        break;
                                                case "Preemptive":
                                                        queue.schedAlgo = "PC";
                        ...
                        // if(queue.schedAlgo != "RR") queue.quantum = 0;
                        newQueue.quantumInput.addFocusListener(new FocusAdapter(){
                                @Override
                                public void focusLost(FocusEvent e){
                                        System.out.println(newQueue.quantumInput.getText());
                                        queue.quantum = Integer.parseInt(newQueue.quantumInput.getText());
                                }
                        });
